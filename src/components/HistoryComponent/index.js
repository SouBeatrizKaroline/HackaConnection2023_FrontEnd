...
function HistoryComponent() {
  ...
  const fetchShippings = () => {
    axios
      .get("https://464b-2804-14c-88-22bf-9c6c-3a60-17cc-f9f9.ngrok-free.app/history")
      .then((response) => {
      ...
      {shippings.length > 0 ? (
        shippings.map((shipping) => (
          <div key={shipping.id}>
            ...
            <p>Return Path: <link href={shipping.returnpath} variant={shipping.returnpath}> </link></p>
